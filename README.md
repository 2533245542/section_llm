This repository contains a self-contained script for an example of creating the inputs to the LLM server (vllm), and postprocessing the outputs of the LLM.
